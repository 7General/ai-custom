...
```python
def determine_workflow(user_input):
    """根据用户输入确定工作流程"""
...
- [质量报告模板](./templates/quality-report-template.md)
- [部署记录模板](./templates/deploy-record-template.md)
- [代码-设计一致性报告模板](./templates/consistency-report-template.md)
