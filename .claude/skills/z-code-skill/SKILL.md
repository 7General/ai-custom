---
name: z-code-skill
description: 编码阶段Skill - 管理代码实现编写。包含代码框架搭建、核心功能实现、代码规范、代码评审。触发关键词：开始编码、编码实现、代码评审、代码检查、代码质量
---
...
代码评审
    ...
    ↓
设计文档生成（必须生成）
    └─ 生成必要文档，docs/code/{feature}-code-design.md
```
...
必须生成代码检查简报文档：
- 保存位置：docs/code/{feature}-design.md
